...
import { MapPin, Clock, CheckCircle, XCircle, AlertTriangle, ChevronLeft, ChevronRight, FileEdit, ClipboardCheck } from "lucide-react";
...
export default function ClockRecordsPage() {
  ...
  const [activeTab, setActiveTab] = useState<"records" | "amendments">("records");
